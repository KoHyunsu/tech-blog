...
<Admonition type="info" title="frameworks-without-the-framework">
  [https://svelte.dev/blog/frameworks-without-the-framework](https://svelte.dev/blog/frameworks-without-the-framework "frameworks without the framework")
</Admonition>
