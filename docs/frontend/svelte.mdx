...
<Admonition type="info" title="framework">
  \["Frameworks without the framework"]\([https://svelte.dev/blog/frameworks-without-the-framework](https://svelte.dev/blog/frameworks-without-the-framework))
</Admonition>
